...
class CropCover extends StatefulWidget {
  final XFile? profile;
  const CropCover(this.profile);
  @override
  _CropCoverState createState() => _CropCoverState();
}

class _CropCoverState extends State<CropCover> {
  XFile? _pickedFile;
  ...
  Future<void> _saveImage() async {
    ...
    await Constants.changeProfile(authToken, authId, file, _path, AppUrl.changeCoverPicture, 'Cover');
    setState(() {
