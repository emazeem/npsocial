...
class _HomeLocationScreenState extends State<HomeLocationScreen> {
  ...
  void initState() {
    ...
    if(userDetail?.latitude!=null){
      double lat=double.parse('${userDetail?.latitude}');
      double long=double.parse('${userDetail?.longitude}');
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text('Search your home location',style: TextStyle(fontSize: 20,color: Colors.grey),),
                            ],
                          ),
                        ),
                      ),
                    ...
                    Container(
                      ...
                      child: Text('This will only record your city, state and country names.',textAlign: TextAlign.start,),
                    ),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          fakeInput('${_currentCity!=null?_currentCity:''}'),
                          Text('State',style: TextStyle(color: Colors.grey),),
                          fakeInput('${_currentState!=null?_currentState:''}'),
                          Text('Country',style: TextStyle(color: Colors.grey),),
                          fakeInput('${_currentCountry!=null?_currentCountry:''}'),
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (response['success'] == true) {
                                    ...
                                    Utils.toastMessage('Home location updated successfully!');
